...
import './DCAManagerLayout.css';

function DCAManagerLayout({ children, activePage, onPageChange }) {
  ...
  return (
    <div className="dca-manager-layout">
      {/* Sidebar */}
      <div className={`dca-sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
          ...
          <div className="user-info-container">
            <div className="user-info-card">
              <div className="user-details">
                <span className="user-label">DCA MANAGER PORTAL</span>
...
export default DCAManagerLayout;
